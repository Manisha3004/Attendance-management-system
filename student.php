...
<a class="navbar-brand" href="index.php" style="font-size:28px;"><br>AMC ENGINEERING COLLEGE</a><br />
 ...
 <div class="container">
  ...
  <form id="getAttendance">
    ...
    <button class="btn btn-primary">Get attendance result</button>
  </form>
  </div>
  </div><!-- /.container -->
<br><br>
   <!-- FOOTER -->
      <footer style="background:; height:;">
        ...
        <p>&copy; 2021 AMC, Inc. &middot;  developed by  <a href="http://localhost/Attendance/">MANISHA SHARMA </a><a href="http://localhost/Attendance/">Privacy</a> &middot; <a href="http://localhost/Attendance/">Terms</a></p>
      </footer>
